...
public class HologramClitcher : MonoBehaviour
{
    ...
    void Update()
    {
        if (!_isGlitched && Random.Range(0f, 1f) < 0.002)
        {
            _isGlitched = true;
    ...
    void GlitchOn()
    {
        ...
        holoRenderer.material.SetFloat("_Ampliture", Random.Range(10, 100));
        holoRenderer.material.SetFloat("_Speed", Random.Range(5, 15));
    }
